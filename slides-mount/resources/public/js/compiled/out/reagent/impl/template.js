...
var G__18925 = o;
(G__18925[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__18926__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__18926 = function (var_args){
var args = null;
...
while (G__18927__i < G__18927__a.length) {G__18927__a[G__18927__i] = arguments[G__18927__i + 0]; ++G__18927__i;}
  args = new cljs.core.IndexedSeq(G__18927__a,0);
} 
return G__18926__delegate.call(this,args);};
G__18926.cljs$lang$maxFixedArity = 0;
G__18926.cljs$lang$applyTo = (function (arglist__18928){
var args = cljs.core.seq(arglist__18928);
return G__18926__delegate(args);
});
G__18926.cljs$core$IFn$_invoke$arity$variadic = G__18926__delegate;
return G__18926;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__16904__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__16904__auto__){
var and__16904__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__16904__auto____$1){
var and__16904__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__16904__auto____$2)){
...
var G__18933 = jsprops;
(G__18933["defaultValue"] = value);

(G__18933["onChange"] = ((function (G__18933,v,value,on_change){
return (function (p1__18931_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__18931_SHARP_);
});})(G__18933,v,value,on_change))
);
...
var vec__18938 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__18938,(0),null);
var id = cljs.core.nth.call(null,vec__18938,(1),null);
var class$ = cljs.core.nth.call(null,vec__18938,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___18941 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___18941 == null)){
} else {
var key_18942 = temp__4661__auto___18941;
(jsprops["key"] = key_18942);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__18944 = (new reagent.impl.template.NativeWrapper());
(G__18944["name"] = c);
...
var len__17974__auto___18950 = arguments.length;
var i__17975__auto___18951 = (0);
while(true){
if((i__17975__auto___18951 < len__17974__auto___18950)){
args__17981__auto__.push((arguments[i__17975__auto___18951]));

var G__18952 = (i__17975__auto___18951 + (1));
i__17975__auto___18951 = G__18952;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__17982__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq18948){
var G__18949 = cljs.core.first.call(null,seq18948);
var seq18948__$1 = cljs.core.next.call(null,seq18948);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__18949,seq18948__$1);
});
...
break;
default:
var G__18956 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__18956;
continue;
...
var n__17819__auto___18957 = a.length;
var i_18958 = (0);
while(true){
if((i_18958 < n__17819__auto___18957)){
(a[i_18958] = reagent.impl.template.as_element.call(null,(a[i_18958])));

var G__18959 = (i_18958 + (1));
i_18958 = G__18959;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__17819__auto___18960 = a.length;
var i_18961 = (0);
while(true){
if((i_18961 < n__17819__auto___18960)){
var val_18962 = (a[i_18961]);
if((cljs.core.vector_QMARK_.call(null,val_18962)) && ((reagent.impl.template.key_from_vec.call(null,val_18962) == null))){
(o["no-key"] = true);
} else {
}

(a[i_18961] = reagent.impl.template.as_element.call(null,val_18962));

var G__18963 = (i_18961 + (1));
i_18961 = G__18963;
continue;
} else {
}
...
var ctx = {};
var vec__18965 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__18965,(0),null);
var derefed = cljs.core.nth.call(null,vec__18965,(1),null);
...
var G__18967 = (cljs.core.count.call(null,argv) - first_child);
switch (G__18967) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__18967){
