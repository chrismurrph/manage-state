...
document.write('<script>if (typeof goog != "undefined") { goog.require("slides_mount.show"); } else { console.warn("ClojureScript could not load :main, did you forget to specify :asset-path?"); };</script>');